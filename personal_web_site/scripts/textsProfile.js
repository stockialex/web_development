const profileTextEsp = `Me llamo Alex y soy un desarrollador front end, con conocimientos de back end, ¿quizá en camino a ser fullstack?
...
const profileTextEng = `Hi! My name is Alex. I'm a front end developer, with some knowledge of back end, maybe on my way to be a fullstack developer?
